...
class Blur {
    ...
    _applyPanelBlur() {
        ...
        this.panel_bg = new Meta.BackgroundActor ({
            ...
            /* get width of dock */
            width: Main.layoutManager.panelBox.height*2+2,
        ...
        // panel itself
        this.panel_bg.set_clip(0, 0, Main.layoutManager.panelBox.height*2+2, 
            this.pMonitor.height-Main.layoutManager.panelBox.height);
